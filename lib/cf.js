...
var bluemixSupportedServiceLabels = Object.keys(bluemixSupportedServices)
                                   .map(function(key) {
  return bluemixSupportedServices[key];
})
 ...
 * @param callback
 */
function getDataServices(accessToken, callback) {
  invokeResource('/v2/services', accessToken, function(err, res, body) {
    ...
    callback(null, getDataServiceDetails);
  });
}
 ...
 * @param callback
 */
function getServicePlans(accessToken, servicePlansUrl, callback) {
 ...
 * @param callback
 */
function bindService(accessToken, details, callback) {
  var options = {
    method: 'post',
    body: details,
  };
  invokeResource('/v2/service_bindings', accessToken, options, callback);
}
 ...
 * @param callback
 */
function provisionService(accessToken, details, callback) {
  var options = {
    method: 'post',
    body: details,
  };
  invokeResource('/v2/service_instances', accessToken, options, callback);
}
